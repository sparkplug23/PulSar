...
// #define _svfwprintf_r 1

  /**
   * 
   * esp01_1m
RAM:   [======    ]  56.2% (used 46024 bytes from 81920 bytes)
Flash: [======    ]  55.4% (used 567184 bytes from 1023984 bytes)
...
RAM:   [======    ]  64.8% (used 53048 bytes from 81920 bytes)
Flash: [======    ]  55.6% (used 569028 bytes from 1023984 bytes)
...
#define USE_DEVFEATURE_PIXEL_OUTPUT_MULTIPLIER 2
  ...
  #define DEVICENAME_FRIENDLY_CTR "RGB Hallway Tree"
