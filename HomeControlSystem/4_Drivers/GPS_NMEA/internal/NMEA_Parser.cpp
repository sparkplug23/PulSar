...
//   } else 
//   if (rxState == NMEA_RECEIVING_DATA) { //---------------------------
...
//   } else 
//   if (rxState == NMEA_RECEIVING_HEADER) { //------------------------
...
//         // Serial.println("merging == NO_MERGING");
//       #if defined(NMEAGPS_TIMESTAMP_FROM_INTERVAL) & \
...
//         // Serial.println("NMEAGPS_FIX_MAX > 0");
//         if (merging != EXPLICIT_MERGING)
//           buffer[ _currentFix ] = fix();
...
//         // Serial.println("storeFix end");
// // Serial.printf("NMEAGPS::handle buffer=%sn\r",buffer);
...
//   // Serial.printf("2parseRMC %c %d\n\r",chr,fieldIndex);
//     switch (fieldIndex) {
//       case 1:  return parseTime ( chr );
//       case 2:  return parseFix ( chr );
//       case 3: return parseLat( chr );
//       case 4: return parseNS ( chr ); 
//       case 5: return parseLon( chr ); 
//       case 6: return parseEW ( chr );
...
//   // Serial.printf(" m_fix.dateTime.hours %d\n\r", m_fix.dateTime.hours);
//         }
//         break;
...
//   Serial.printf("NMEAGPS::parseDDMMYY( %c ) \n\r",chr);
