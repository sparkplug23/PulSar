#ifndef MWLEDEFFECTS_preeog2_H
#define MWLEDEFFECTS_preeog2_H 0.1
...
#include "6_Lights/Animator/EffectsWLEDConversion/progmem_defines.h"
   ...
   * */
    ...
    WS2812FX() {
      ...
      * */
      ...
      _mode[FX_MODE_CANDLE]                  = &WS2812FX::mode_candle;                    // Added to Segments successfully
      _mode[FX_MODE_CANDLE_MULTI]            = &WS2812FX::mode_candle_multi;              // Added to Segments successfully
    ...
    void
      Init_WLED_Conversion(bool supportWhite, uint16_t countPixels, bool skipFirst),
      service(void),
      blur(uint8_t),
      fade_out(uint8_t r),
