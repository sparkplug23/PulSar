...
void Pre_Init(void);
    ...
    static const char* PM_MODULE_CONTROLLER_BUCKET_WATER_LEVEL_CTR;
    static const char* PM_MODULE_CONTROLLER_BUCKET_WATER_LEVEL_FRIENDLY_CTR;
    PGM_P GetModuleName(){          return PM_MODULE_CONTROLLER_BUCKET_WATER_LEVEL_CTR; }
    PGM_P GetModuleFriendlyName(){  return PM_MODULE_CONTROLLER_BUCKET_WATER_LEVEL_FRIENDLY_CTR; }
    uint8_t GetModuleUniqueID(){ return D_UNIQUE_MODULE_CONTROLLER_BUCKET_WATER_LEVEL_ID; }
