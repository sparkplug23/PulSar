...
void mUARTLogger::MQTTHandler_Init(){
  ...
  struct handler<mUARTLogger>* mqtthandler_ptr;
  ...
  mqtthandler_ptr->ConstructJSON_function = &mUARTLogger::ConstructJSON_Settings;
  ...
  mqtthandler_ptr->ConstructJSON_function = &mUARTLogger::ConstructJSON_Sensor;
...
void mUARTLogger::MQTTHandler_Set_TelePeriod(){
