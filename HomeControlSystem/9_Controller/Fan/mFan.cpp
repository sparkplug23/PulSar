...
// void mFan::SonoffIfanReceived(void)
// {
//   char svalue[32];
...
//   }
// }
// int8_t mFan::CheckAndExecute_JSONCommands(JsonObjectConst obj){
...
// void mFan::parse_JSONCommand(JsonObjectConst obj){

//   // Serial.println("mFan::parsesub_Commands(JsonObjectConst obj)");
...
// int8_t mFan::Tasker_Web(uint8_t function){
...
void mFan::MQTTHandler_Init(){
  ...
  mqtthandler_ptr->ConstructJSON_function = &mFan::ConstructJSON_Settings;
  ...
  mqtthandler_ptr->ConstructJSON_function = &mFan::ConstructJSON_Sensor;
...
void mFan::MQTTHandler_Sender(uint8_t mqtt_handler_id){
  ...
  struct handler<mFan>* mqtthandler_list_ptr[] = {
