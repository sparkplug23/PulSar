...
void mSecurityLight::init(void){
  
  // AddLog_P(LOG_LEVEL_DEBUG_LOWLEVEL, PSTR(D_LOG_GARAGE D_DEBUG_FUNCTION "\"%s\""),"mSecurityLight::init");
...
int8_t mSecurityLight::Tasker(uint8_t function){
...
*/
  ...
  //   // AddLog_P(LOG_LEVEL_DEBUG, PSTR(D_LOG_GARAGE D_DEBUG_FUNCTION "\"%s\""),"mSecurityLight::SubTask_Light");
...
uint8_t mSecurityLight::ConstructJSON_Sensor(uint8_t json_level){
...
// void mSecurityLight::MQTTSendLightStatesIfChanged(void){
...
//   }
// }
uint8_t mSecurityLight::ConstructJSON_LightStates(uint8_t json_level){
  ...
  //     relayobj["onoff"] = pCONT->mry->CommandGet_Relay_Power(device_id);
...
void mSecurityLight::MQTTHandler_Init(){
  ...
  mqtthandler_ptr->ConstructJSON_function = &mSecurityLight::ConstructJSON_Settings;
...
void mSecurityLight::MQTTHandler_Set_fSendNow(){
...
void mSecurityLight::MQTTHandler_Set_TelePeriod(){
