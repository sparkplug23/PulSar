...
class mSecurityLight{
  ...
  //#ifdef USE_CORE_MQTT 
    ...
    struct handler<mSecurityLight> mqtthandler_settings_teleperiod;
    // const char* PM_MQTT_HANDLER_POSTFIX_TOPIC_SENSORS_CTR = "sensors";
    struct handler<mSecurityLight> mqtthandler_sensor_ifchanged;
    struct handler<mSecurityLight> mqtthandler_sensor_teleperiod;
