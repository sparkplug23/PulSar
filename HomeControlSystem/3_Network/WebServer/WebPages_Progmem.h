...
// var c = json.names().getString(k);
    ...
    <script>
        ...
        function send_select(url,mess){
            ...
            // var url = "/rgb_controls/save_animation_controls";
            xhr.open("POST", url, true);
            xhr.setRequestHeader("Content-Type", "application/json");
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    var json = JSON.parse(xhr.responseText);
                    console.log('response',json);//json.email + ", " + json.password);
                }
            };
...
// //   "}";
        ...
        function start_form_listener(){
            ...
            if(form){
                ...
                //send_select(form.action,data);

                
            console.log('new FormData(form).entries()',new FormData(form).entries());
                ...
                // // xhr.onreadystatechange=function(){
                // // if(xhr.readyState==4&&xhr.status==200){
                // //     var s=xhr.responseText.replace(/{t}/g,"<table style='width:100%'>")
                // //                         .replace(/{s}/g,"<tr><th>")
                // //                         .replace(/{m}/g,"</th><td>")
                // //                         .replace(/{e}/g,"</td></tr>")
                // //                         .replace(/{t2}/g,"</table>")
                ...
                // //     // eb('l1').innerHTML=s;
                // //     document.getElementsByClassName("container_5")[0].innerHTML=s;
                // // }
...
//         <!-- <form id="json_command_form"  action="/test" method="post">
