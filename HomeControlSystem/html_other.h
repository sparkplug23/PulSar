...
// Autogenerated from HomeControlSystem/data/usermod.htm, do not edit!!
const char PAGE_usermod[] PROGMEM = R"=====(<!DOCTYPE html><html><body>No usermod custom web page set.</body></html>)=====";


// Autogenerated from HomeControlSystem/data/msg.htm, do not edit!!
...
// Autogenerated from HomeControlSystem/data/dmxmap.htm, do not edit!!
...
// Autogenerated from HomeControlSystem/data/update.htm, do not edit!!
...
// Autogenerated from HomeControlSystem/data/welcome.htm, do not edit!!
...
// Autogenerated from HomeControlSystem/data/liveview.htm, do not edit!!
