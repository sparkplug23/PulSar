...
void mRemoteDevice::MQTTHandler_Init(){
  ...
  struct handler<mRemoteDevice>* mqtthandler_ptr;
  ...
  mqtthandler_ptr->ConstructJSON_function = &mRemoteDevice::ConstructJSON_Settings;
  ...
  mqtthandler_ptr->ConstructJSON_function = &mRemoteDevice::ConstructJSON_Sensor;
