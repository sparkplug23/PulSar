...
struct ISR_DUAL_CAPTURE{
  ...
  uint8_t active_buffer_to_write_to_index = 0;
    ...
    static const char* PM_MODULE_SENSORS_ADC_INTERNAL_CTR;
    static const char* PM_MODULE_SENSORS_ADC_INTERNAL_FRIENDLY_CTR;
    PGM_P GetModuleName(){          return PM_MODULE_SENSORS_ADC_INTERNAL_CTR; }
    PGM_P GetModuleFriendlyName(){  return PM_MODULE_SENSORS_ADC_INTERNAL_FRIENDLY_CTR; }
    uint8_t GetModuleUniqueID(){ return D_UNIQUE_MODULE_SENSORS_ADC_INTERNAL_ID; }

    #ifdef USE_DEBUG_CLASS_SIZE
    uint16_t GetClassSize(){
      return sizeof(mADCInternal);
    };
    #endif
...
void Update_Channel1_ADC_Readings();
    ...
    struct handler<mADCInternal>* mqtthandler_list[3] = {
