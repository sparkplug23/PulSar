...
// END OF BOOT SECTION 
  ...
  FUNC_EVENT_PRESENCE_STARTED_ID,
  FUNC_EVENT_PRESENCE_ENDED_ID,
...
DEFINE_PGM_CTR(PM_FUNC_EVENT_PRESENCE_STARTED_CTR)  D_FUNC_EVENT_PRESENCE_STARTED_CTR;
DEFINE_PGM_CTR(PM_FUNC_EVENT_PRESENCE_ENDED_CTR)  D_FUNC_EVENT_PRESENCE_ENDED_CTR;
