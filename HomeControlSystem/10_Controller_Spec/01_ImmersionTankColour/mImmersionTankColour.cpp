...
uint8_t mImmersionTankColour::ConstructJSON_Settings(uint8_t json_method){
...
uint8_t mImmersionTankColour::ConstructJSON_Sensor(uint8_t json_method){
...
void mImmersionTankColour::MQTTHandler_Init(){
  ...
  mqtthandler_ptr->ConstructJSON_function = &mImmersionTankColour::ConstructJSON_Settings;
  ...
  mqtthandler_ptr->ConstructJSON_function = &mImmersionTankColour::ConstructJSON_Sensor;

  mqtthandler_ptr = &mqtthandler_sensor_ifchanged;
  mqtthandler_ptr->tSavedLastSent = millis();
  mqtthandler_ptr->flags.PeriodicEnabled = true;
  mqtthandler_ptr->flags.SendNow = true;
  mqtthandler_ptr->tRateSecs = 60; // water never changes fast 
