...
#include "2_CoreSystem/Settings/mSettings.h"
  ...
  DEFINE_PGM_CTR(PM_LOG_LEVEL_INFO_PARSING_SHORT_CTR)    D_LOG_LEVEL_INFO_PARSING_SHORT_CTR;
  ...
  DEFINE_PGM_CTR(PM_LOG_LEVEL_INFO_PARSING_LONG_CTR)    D_LOG_LEVEL_INFO_PARSING_LONG_CTR;
