...
// \*********************************************************************************************/
  ...
  // Will only exist once, as the default
  #ifndef DEFAULT_LIGHTING_TRANSITION_ORDER_ID
    #define DEFAULT_LIGHTING_TRANSITION_ORDER_ID           UO_TRANSITION_ORDER_RANDOM_ID  
  #endif
  #ifndef DEFAULT_LIGHTING_TRANSITION_TIME_MAP_SECS_ID
    #define DEFAULT_LIGHTING_TRANSITION_TIME_MAP_SECS_ID   UO_TIME_MAP_SECS_4_ID  
  #endif
  #ifndef DEFAULT_LIGHTING_TRANSITION_RATE_MAP_SECS_ID
    #define DEFAULT_LIGHTING_TRANSITION_RATE_MAP_SECS_ID   UO_RATE_MAP_SECS_10_ID  
  #endif
  #ifndef DEFAULT_LIGHTING_ANIMATION_PALETTE_ID
    #define DEFAULT_LIGHTING_ANIMATION_PALETTE_ID          UO_PALETTELIST_VARIABLE_USER_16_ID  
  #endif
  #ifndef DEFAULT_LIGHTING_ANIMATION_MODE_ID
    #define DEFAULT_LIGHTING_ANIMATION_MODE_ID             UO_ANIMATION_MODE_EFFECTS_ID  
  #endif
  #ifndef DEFAULT_LIGHTING_EFFECTS_FUNCTION_ID
    #define DEFAULT_LIGHTING_EFFECTS_FUNCTION_ID           UO_EFFECTS_FUNCTION_SLOW_GLOW_ID  
  #endif
  #ifndef DEFAULT_LIGHTING_PIXELS_UPDATE_PERCENTAGE_ID
    #define DEFAULT_LIGHTING_PIXELS_UPDATE_PERCENTAGE_ID   UO_PIXELS_UPDATE_PERCENTAGE_50_ID  
  #endif
  #ifndef DEFAULT_LIGHTING_BRIGHTNESS_PERCENTAGE
...
// #ifndef WS2812_LEDS
// #define WS2812_LEDS            30             // [Pixels] Number of ledout.index
// #endif
...
//#define MESSZ                (MQTT_MAX_PACKET_SIZE -TOPSZ -7)  // Max number of characters in JSON message string (6 x DS18x20 sensors)
  ...
  #define MESSZ                  1000  // Max number of characters in JSON message string (6 x DS18x20 sensors)
#else
  #define MESSZ                  1000  // Max number of characters in JSON message string (6 x DS18x20 sensors)
#endif
