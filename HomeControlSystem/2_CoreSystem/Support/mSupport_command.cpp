...
//     }
//   }
//   Response_P(PSTR("{\"" D_JSON_I2CDRIVER "\":"));
//   I2cDriverState();
//   ResponseJsonEnd();
// }
// #endif  // USE_I2C
...
//   Response_P(PSTR("{\"" D_JSON_DEVGROUP_SHARE "\":{\"In\":\"%X\",\"Out\":\"%X\"}}"), Settings.device_group_share_in, Settings.device_group_share_out);
// }
...
//   }
//   Response_P(PSTR("{\"" D_JSON_TOUCH_CAL "\": %u"), TOUCH_BUTTON.calibration);
//   ResponseJsonEnd();
...
//     }
//   }
//   Response_P(PSTR("{\"" D_JSON_TOUCH_THRES "\": %u"), TOUCH_BUTTON.pin_threshold);
//   ResponseJsonEnd();
// }
...
//     }
//   }
//   Response_P(PSTR("{\"" D_JSON_TOUCH_NUM "\": %u"), TOUCH_BUTTON.hit_threshold);
//   ResponseJsonEnd();
