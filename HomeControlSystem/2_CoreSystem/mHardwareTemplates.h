...
enum USER_SELECTABLE_PINS_StaticCompleteList_IDS {
  ...
  // User connected external switches
  ...
  GPIO_KEY1_INV_ID, GPIO_KEY2_INV_ID, GPIO_KEY3_INV_ID, GPIO_KEY4_INV_ID, // Inverted buttons
  GPIO_KEY1_INV_NP_ID, GPIO_KEY2_INV_NP_ID, GPIO_KEY3_INV_NP_ID, GPIO_KEY4_INV_NP_ID, // Inverted buttons without pull-up
  // Button usually connected to GPIO0
  GPIO_KEY1_NP_ID, GPIO_KEY2_NP_ID, GPIO_KEY3_NP_ID, GPIO_KEY4_NP_ID, GPIO_CNTR1_NP_ID, GPIO_CNTR2_NP_ID, GPIO_CNTR3_NP_ID, GPIO_CNTR4_NP_ID,
  // Relays
  ...
  GPIO_SERIAL_TX_ID, GPIO_SERIAL_RX_ID,
  GPIO_SERIAL_DEBUG_TX_ID, GPIO_SERIAL_DEBUG_RX_ID,
  // Rotary switch
  GPIO_ROT1A_ID, GPIO_ROT1B_ID, GPIO_ROT2A_ID, GPIO_ROT2B_ID,
  // PIR Motion 
  GPIO_PIR_1_ID, GPIO_PIR_2_ID,         //pullup
  GPIO_PIR_1_NP_ID, GPIO_PIR_2_NP_ID,
  GPIO_PIR_1_INV_ID, GPIO_PIR_2_INV_ID, //pulldown
  // Link/Status led
  ...
  GPIO_SENSOR_END_ID }; // used 171of 250
...
DEFINE_PGM_CTR(PM_GPIO_FUNCTION_LEDLNK_INV_CTR)         D_GPIO_FUNCTION_LEDLNK_INV_CTR;
...
DEFINE_PGM_CTR(PM_GPIO_FUNCTION_SERIAL_DEBUG_TX_CTR)  D_GPIO_FUNCTION_SERIAL_DEBUG_TX_ID;
DEFINE_PGM_CTR(PM_GPIO_FUNCTION_SERIAL_DEBUG_RX_CTR)  D_GPIO_FUNCTION_SERIAL_DEBUG_RX_ID;
