 ...
 */
 ...
 #ifndef DEFINE_HEADER_PAGE_ROOT1
 #define DEFINE_HEADER_PAGE_ROOT1
 
// Autogenerated from ${sourceFile}, do not edit!!
const uint16_t PAGE_ROOT_L = ${result.length};
...
function writeHtmlGzippedExtern(sourceFile, resultFile, resultFileName) {
  console.info("Reading " + sourceFile);
  new inliner(sourceFile, function (error, html) {
    console.info("Inlined " + html.length + " characters");
...
`;
      ...
      console.info("Writing " + resultFile);
      fs.writeFileSync(resultFile+".h", header_data);
      fs.writeFileSync(resultFile+".cpp", cpp_data);
    });
  });
}
...
//     // },
//   ],
//   "HomeControlSystem/html_other.h"
// );
