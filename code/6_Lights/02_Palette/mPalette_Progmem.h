...
#define D_PALETTE_PASTEL_01_NAME_CTR        "Pastel Easter/Pastel Easter/Pastel/Easter"      // using / delimiter to allow for multiple names within a single palette, this must be different from the "|" used for delimiting between palettes
#endif
...
DEFINE_PGM_CTR(PM_STATIC__PALETTES_NAMES_CTR)
{
  ...
  D_PALETTE__CHRISTMAS_COLD_WHITE__NAME_CTR "|"
  D_PALETTE__CHRISTMAS_WARM_WHITE__NAME_CTR "|"
...
DEFINE_PGM_CTR(PM_MODIFIABLE__RGBCCT_CRGBPALETTE16_PALETTES_NAMES_CTR)
{
...
DEFINE_PGM_CTR(PM_MODIFIABLE__RGBCCT_SOLID_COLOUR__NAMES_CTR)
{
