...
#define D_EFFECTS_FUNCTION__BLEND_PALETTE_SATURATION_TO_WHITE__NAME_CTR "Blend Palette to White"
#define D_EFFECTS_FUNCTION__CANDLE_FLICKER_PALETTE_SATURATION_TO_WHITE__NAME_CTR "Candle Flicker Palette to White"
