...
#define D_EFFECTS_FUNCTION__WLED_CANDLE_SINGLE__NAME_CTR      "Candle|Candle Single"
#define D_EFFECTS_FUNCTION__WLED_CANDLE_MULTIPLE__NAME_CTR    "Shimmer|Candle Multiple"
