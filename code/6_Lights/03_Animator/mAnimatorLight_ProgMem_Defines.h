...
DEFINE_PGM_CTR(PM_EFFECTS_FUNCTION__BLEND_PALETTE_SATURATION_TO_WHITE__NAME_CTR)               D_EFFECTS_FUNCTION__BLEND_PALETTE_SATURATION_TO_WHITE__NAME_CTR;
DEFINE_PGM_CTR(PM_EFFECTS_FUNCTION__CANDLE_FLICKER_PALETTE_SATURATION_TO_WHITE__NAME_CTR)               D_EFFECTS_FUNCTION__CANDLE_FLICKER_PALETTE_SATURATION_TO_WHITE__NAME_CTR;
