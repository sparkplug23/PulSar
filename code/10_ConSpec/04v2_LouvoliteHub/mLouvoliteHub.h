...
*/
#ifndef HEADER_CONTROLLER_LOUVOLITE_HUB_H_V2
#define HEADER_CONTROLLER_LOUVOLITE_HUB_H_V2
  ...
  public mTaskerInterface
{
  ...
  public:
    ...
    static const char* PM_MODULE_CONTROLLER_LOUVOLITE_HUB_CTR;
    static const char* PM_MODULE_CONTROLLER_LOUVOLITE_HUB_FRIENDLY_CTR;
    PGM_P GetModuleName(){          return PM_MODULE_CONTROLLER_LOUVOLITE_HUB_CTR; }
    PGM_P GetModuleFriendlyName(){  return PM_MODULE_CONTROLLER_LOUVOLITE_HUB_FRIENDLY_CTR; }
    ...
    #define D_LOUVOLITE_COMMAND_UP__BEDROOM__BINARY_CTR          "1010110010100000111100101111011100111111000000000000101111010011"
    #define D_LOUVOLITE_COMMAND_UP__BEDROOM__HEX                 (uint64_t)0xACA0F2F73F000BD3
    #define D_LOUVOLITE_COMMAND_STOP__BEDROOM__BINARY_CTR        "1010110010100000111100101111011100111111000000000010001111101011"
    #define D_LOUVOLITE_COMMAND_STOP__BEDROOM__HEX               (uint64_t)0xACA0F2F73F0023EB
    #define D_LOUVOLITE_COMMAND_DOWN__BEDROOM__BINARY_CTR        "1010110010100000111100101111011100111111000000000100001100001011"
    #define D_LOUVOLITE_COMMAND_DOWN__BEDROOM__HEX               (uint64_t)0xACA0F2F73F00430B

    #define D_LOUVOLITE_COMMAND_UP__MASTERBEDROOM__BINARY_CTR    "1010110010100001011001011100001100111111000000000000101100010011"
    #define D_LOUVOLITE_COMMAND_UP__MASTERBEDROOM__HEX           (uint64_t)0xACA165C33F000B13
    #define D_LOUVOLITE_COMMAND_STOP__MASTERBEDROOM__BINARY_CTR  "1010110010100001011001011100001100111111000000000010001100101011"
    #define D_LOUVOLITE_COMMAND_STOP__MASTERBEDROOM__HEX         (uint64_t)0xACA165C33F00232B
    #define D_LOUVOLITE_COMMAND_DOWN__MASTERBEDROOM__BINARY_CTR  "1010110010100001011001011100001100111111000000000100001101001011"
    #define D_LOUVOLITE_COMMAND_DOWN__MASTERBEDROOM__HEX         (uint64_t)0xACA165C33F00434B
   ...
   * 
   */
  enum EM_DEVICE_NAME_IDS{
    EM_DEVICE__BEDROOM_ID,
    EM_DEVICE__MASTERBEDROOM_ID
  };
    ...
    void CommandSet_BlindTransmit_ByID(int8_t id, int8_t device_id = -1);
    ...
    void CommandSet_BlindTransmit_Up_Step(int8_t device_id = -1);
    void CommandSet_BlindTransmit_Down_Step(int8_t device_id = -1);
    void CommandSet_BlindTransmit_Up_Full(int8_t device_id = -1);
    void CommandSet_BlindTransmit_Down_Full(int8_t device_id = -1);
    void CommandSet_BlindTransmit_Stop(int8_t device_id = -1);
    ...
    struct handler<mLouvoliteHub> mqtthandler_settings_teleperiod;
