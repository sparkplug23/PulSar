...
#define D_UNIQUE_MODULE_CONTROLLER_SERIAL_POSITIONAL_LOGGER_ID   10018 // [(Folder_Number*100)+ID_File]  // Unique value across all classes from all groups (e.g. sensor, light, driver, energy)
