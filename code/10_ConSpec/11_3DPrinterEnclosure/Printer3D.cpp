...
const char* mPrinter3D::PM_MODULE_CONTROLLER_CUSTOM__3DPRINTER_ENCLOSURE_CTR = D_MODULE_CONTROLLER_CUSTOM__3DPRINTER_ENCLOSURE_CTR;
const char* mPrinter3D::PM_MODULE_CONTROLLER_CUSTOM__3DPRINTER_ENCLOSURE_FRIENDLY_CTR = D_MODULE_CONTROLLER_CUSTOM__3DPRINTER_ENCLOSURE_FRIENDLY_CTR;
 ...
 * */
void mPrinter3D::MQTTHandler_Sender(uint8_t id)
{
  for(auto& handle:mqtthandler_list){
    pCONT_mqtt->MQTTHandler_Command(*this, EM_MODULE_CONTROLLER_CUSTOM__3DPRINTER_ENCLOSURE__ID, handle, id);
  }
}
