...
void mMavlinkFlyingLEDS::EveryLoop()
{
  ...
  // PacketData* packet_rc_channels = tkr_mavlink->findPacketData(PacketID::PKT_ID__RC_CHANNELS);
  ...
  else if((pwm_led_mode > 1400) && (pwm_led_mode <= 1600)){ mode = 2; } // Centre
 ...
 * 
 * */
void mMavlinkFlyingLEDS::SubTask_UpdateOLED()
{
