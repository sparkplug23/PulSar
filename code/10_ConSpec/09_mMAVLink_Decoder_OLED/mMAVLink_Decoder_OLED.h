...
#define D_UNIQUE_MODULE_CONTROLLER_CUSTOM__CELLULAR_MAVLINK_BLACK_BOX_OLED_ID 10009 // [(Folder_Number*100)+ID_File]
  ...
  public mTaskerInterface
{
  ...
  public:
    ...
    static constexpr const char* PM_MODULE_CONTROLLER_CUSTOM__CELLULAR_MAVLINK_BLACK_BOX_OLED_CTR = D_MODULE__CONTROLLER_CUSTOM__CELLULAR_MAVLINK_BLACK_BOX_OLED__CTR;
    ...
    struct telemetry_handler<mMAVLink_Decoder_OLED> telemetry_settings;
    struct telemetry_handler<mMAVLink_Decoder_OLED> telemetry_state_ifchanged;

    //No extra handlers: ie settings and "state" only
    
      
    struct telemetry_handler<mMAVLink_Decoder_OLED>* telemetry_list[2] = {
      &telemetry_settings,
