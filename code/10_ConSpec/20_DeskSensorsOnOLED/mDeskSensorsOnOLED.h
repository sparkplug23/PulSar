  ...
  public mTaskerInterface
{
  ...
  public:
    ...
    static const char* PM_MODULE_CONTROLLER_CUSTOM__DESK_SENSORS_ON_OLED_CTR;
    static const char* PM_MODULE_CONTROLLER_CUSTOM__DESK_SENSORS_ON_OLED_FRIENDLY_CTR;
    PGM_P GetModuleName(){          return PM_MODULE_CONTROLLER_CUSTOM__DESK_SENSORS_ON_OLED_CTR; }
    PGM_P GetModuleFriendlyName(){  return PM_MODULE_CONTROLLER_CUSTOM__DESK_SENSORS_ON_OLED_FRIENDLY_CTR; }
