...
#define D_UNIQUE_MODULE_CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX_ID 10008 // [(Folder_Number*100)+ID_File]
  ...
  public mTaskerInterface
{
  ...
  public:
    ...
    static constexpr const char* PM_MODULE_CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX_CTR = D_MODULE__CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX__CTR;
    ...
    struct telemetry_handler<mCellularBlackBox> telemetry_settings;
    struct telemetry_handler<mCellularBlackBox> telemetry_state_ifchanged;

    //No extra handlers: ie settings and "state" only
    
      
    struct telemetry_handler<mCellularBlackBox>* telemetry_list[2] = {
      &telemetry_settings,
