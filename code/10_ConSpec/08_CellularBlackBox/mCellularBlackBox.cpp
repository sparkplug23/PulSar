...
const char* mCellularBlackBox::PM_MODULE_CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX_CTR = D_MODULE_CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX_CTR;
const char* mCellularBlackBox::PM_MODULE_CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX_FRIENDLY_CTR = D_MODULE_CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX_FRIENDLY_CTR;
