#ifndef _mWLEDWebUI_TESTER_H
#define _mWLEDWebUI_TESTER_H

#define D_UNIQUE_MODULE_CONTROLLER_CUSTOM__WLED_WEBUI_TESTER__ID   ((10*1000)+11)
  ...
  public mTaskerInterface
{
  public:
    ...
    static const char* PM_MODULE_CONTROLLER_CUSTOM__WLED_WEBUI_TESTER__CTR;
    static const char* PM_MODULE_CONTROLLER_CUSTOM__WLED_WEBUI_TESTER__FRIENDLY_CTR;
    PGM_P GetModuleName(){          return PM_MODULE_CONTROLLER_CUSTOM__WLED_WEBUI_TESTER__CTR; }
    PGM_P GetModuleFriendlyName(){  return PM_MODULE_CONTROLLER_CUSTOM__WLED_WEBUI_TESTER__FRIENDLY_CTR; }
    uint16_t GetModuleUniqueID(){ return D_UNIQUE_MODULE_CONTROLLER_CUSTOM__WLED_WEBUI_TESTER__ID; }
