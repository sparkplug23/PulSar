...
namespace ublox {
    ...
    enum msg_class_t
      ...
      enum msg_id_t
      {
        ...
        UBX_NAV_TIMEGLO   = 0x23, // GLONASS time solution
        UBX_NAV_TIMEBDS   = 0x24, // BeiDou time solution
        UBX_NAV_TIMEGAL   = 0x25, // Galileo time solution
        UBX_NAV_TIMEQZSS  = 0x27, // QZSS time solution
        UBX_NAV_SVINFO    = 0x30, // Space Vehicle Information (legacy)
        UBX_NAV_SBAS      = 0x32, // SBAS status data
        UBX_NAV_ORB       = 0x34, // GNSS orbit database info
        UBX_NAV_SAT       = 0x35, // Satellite information
        UBX_NAV_COV       = 0x36, // Covariance matrices
        UBX_NAV_GEOFENCE  = 0x39, // Geofencing status
        UBX_NAV_SLAS      = 0x42, // QZSS L1S SLAS status data
      ...
      static const uint8_t UBX_NAV_LIST[] = {
        ublox::UBX_NAV_POSECEF,
        ublox::UBX_NAV_POSLLH,
        ublox::UBX_NAV_STATUS,
        ublox::UBX_NAV_DOP,
        ublox::UBX_NAV_PVT,
        ublox::UBX_NAV_ODO,
        ublox::UBX_NAV_RESETODO,
        ublox::UBX_NAV_VELECEF,
        ublox::UBX_NAV_VELNED,
        ublox::UBX_NAV_TIMEGPS,
        ublox::UBX_NAV_TIMEUTC,
        ublox::UBX_NAV_CLOCK,
        ublox::UBX_NAV_TIMEGLO,
        ublox::UBX_NAV_TIMEBDS,
        ublox::UBX_NAV_TIMEGAL,
        ublox::UBX_NAV_TIMEQZSS,
        ublox::UBX_NAV_SVINFO,
        ublox::UBX_NAV_SBAS,
        ublox::UBX_NAV_ORB,
        ublox::UBX_NAV_SAT,
        ublox::UBX_NAV_COV,
        ublox::UBX_NAV_GEOFENCE,
        ublox::UBX_NAV_SLAS,
        ublox::UBX_NAV_SIG,
        ublox::UBX_NAV_AOPSTATUS,
        ublox::UBX_NAV_EOE
      };
