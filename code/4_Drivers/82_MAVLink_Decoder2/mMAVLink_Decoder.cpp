...
//     //     updatePacket(msg, PacketID::PKT_ID__ACTUATOR_CONTROL_TARGET, PSTR("ACTUATOR_CONTROL_TARGET"), sizeof(mavlink_actuator_control_target_t));
//     //     break;
//     // case MAVLINK_MSG_ID_ADAP_TUNING:
//     //     updatePacket(msg, PacketID::PKT_ID__ADAP_TUNING, PSTR("ADAP_TUNING"), sizeof(mavlink_adap_tuning_t));
//     //     break;
//     // case MAVLINK_MSG_ID_ADSB_VEHICLE:
//     //     updatePacket(msg, PacketID::PKT_ID__ADSB_VEHICLE, PSTR("ADSB_VEHICLE"), sizeof(mavlink_adsb_vehicle_t));
//     //     break;
//     // case MAVLINK_MSG_ID_AHRS:
//     //     updatePacket(msg, PacketID::PKT_ID__AHRS, PSTR("AHRS"), sizeof(mavlink_ahrs_t));
//     //     break;
//     case MAVLINK_MSG_ID_AHRS2:{
//         ALOG_INF(PSTR("AHRS2"));
...
//         mavlink_msg_ahrs2_decode(&msg, &data);    
//         Serial.print("data.roll=");Serial.println(data.roll);

//         // for(int i=0;i<10;i++){ Serial.print(&data + i); Serial.print(","); } Serial.println();
//         // Serial.println(data.roll);


//         updatePacket(msg, PacketID::PKT_ID__AHRS2, PM_MAVLINK_MSG_PACKET_NAME__AHRS2__CTR, sizeof(mavlink_ahrs2_t));

          
//         PacketData* packet_ahrs2 = findPacketData(PacketID::PKT_ID__AHRS2);
//         if (packet_ahrs2 != nullptr && packet_ahrs2->data != nullptr) {
//           mavlink_ahrs2_t* data = static_cast<mavlink_ahrs2_t*>(packet_ahrs2->data);
//           Serial.print("NEW data.roll=");Serial.println(data->roll);
//         }
...
//     break;
//     // case MAVLINK_MSG_ID_ATTITUDE:
//     //     updatePacket(msg, PacketID::PKT_ID__ATTITUDE, PSTR("ATTITUDE"), sizeof(mavlink_attitude_t));
//     //     break;
//     // case MAVLINK_MSG_ID_AUTOPILOT_VERSION:
//     //     updatePacket(msg, PacketID::PKT_ID__AUTOPILOT_VERSION, PSTR("AUTOPILOT_VERSION"), sizeof(mavlink_autopilot_version_t));
//     //     break;
//     // case MAVLINK_MSG_ID_BATTERY_STATUS:
//     //     updatePacket(msg, PacketID::PKT_ID__BATTERY_STATUS, PSTR("BATTERY_STATUS"), sizeof(mavlink_battery_status_t));
//     //     break;
//     // case MAVLINK_MSG_ID_EKF_STATUS_REPORT:
//     //     updatePacket(msg, PacketID::PKT_ID__EKF_STATUS_REPORT, PSTR("EKF_STATUS_REPORT"), sizeof(mavlink_ekf_status_report_t));
//     //     break;
//     // case MAVLINK_MSG_ID_FENCE_STATUS:
//     //     updatePacket(msg, PacketID::PKT_ID__FENCE_STATUS, PSTR("FENCE_STATUS"), sizeof(mavlink_fence_status_t));
//     //     break;
//     // case MAVLINK_MSG_ID_GIMBAL_REPORT:
//     //     updatePacket(msg, PacketID::PKT_ID__GIMBAL_REPORT, PSTR("GIMBAL_REPORT"), sizeof(mavlink_gimbal_report_t));
//     //     break;
//     // case MAVLINK_MSG_ID_GIMBAL_TORQUE_CMD_REPORT:
//     //     updatePacket(msg, PacketID::PKT_ID__GIMBAL_TORQUE_CMD_REPORT, PSTR("GIMBAL_TORQUE_CMD_REPORT"), sizeof(mavlink_gimbal_torque_cmd_report_t));
//     //     break;
//     // case MAVLINK_MSG_ID_GLOBAL_POSITION_INT:
//     //     updatePacket(msg, PacketID::PKT_ID__GLOBAL_POSITION_INT, PSTR("GLOBAL_POSITION_INT"), sizeof(mavlink_global_position_int_t));
//     //     break;
//     // case MAVLINK_MSG_ID_GOPRO_HEARTBEAT:
//     //     updatePacket(msg, PacketID::PKT_ID__GOPRO_HEARTBEAT, PSTR("GOPRO_HEARTBEAT"), sizeof(mavlink_gopro_heartbeat_t));
//     //     break;
//     // case MAVLINK_MSG_ID_GOPRO_SET_RESPONSE:
//     //     updatePacket(msg, PacketID::PKT_ID__GOPRO_SET_RESPONSE, PSTR("GOPRO_SET_RESPONSE"), sizeof(mavlink_gopro_set_response_t));
//     //     break;
//     // case MAVLINK_MSG_ID_GPS_GLOBAL_ORIGIN:
//     //     updatePacket(msg, PacketID::PKT_ID__GPS_GLOBAL_ORIGIN, PSTR("GPS_GLOBAL_ORIGIN"), sizeof(mavlink_gps_global_origin_t));
//     //     break;
//     // case MAVLINK_MSG_ID_GPS_RAW_INT:
//     //     updatePacket(msg, PacketID::PKT_ID__GPS_RAW_INT, PSTR("GPS_RAW_INT"), sizeof(mavlink_gps_raw_int_t));
//     //     break;
//     // case MAVLINK_MSG_ID_HEARTBEAT:
//     //     updatePacket(msg, PacketID::PKT_ID__HEARTBEAT, PSTR("HEARTBEAT"), sizeof(mavlink_heartbeat_t));
//     //     break;
//     // case MAVLINK_MSG_ID_HOME_POSITION:
//     //     updatePacket(msg, PacketID::PKT_ID__HOME_POSITION, PSTR("HOME_POSITION"), sizeof(mavlink_home_position_t));
//     //     break;
//     // case MAVLINK_MSG_ID_HWSTATUS:
//     //     updatePacket(msg, PacketID::PKT_ID__HWSTATUS, PSTR("HWSTATUS"), sizeof(mavlink_hwstatus_t));
//     //     break;
//     // case MAVLINK_MSG_ID_LOCAL_POSITION_NED:
//     //     updatePacket(msg, PacketID::PKT_ID__LOCAL_POSITION_NED, PSTR("LOCAL_POSITION_NED"), sizeof(mavlink_local_position_ned_t));
//     //     break;
//     // case MAVLINK_MSG_ID_MEMINFO:
//     //     updatePacket(msg, PacketID::PKT_ID__MEMINFO, PSTR("MEMINFO"), sizeof(mavlink_meminfo_t));
//     //     break;
//     // case MAVLINK_MSG_ID_MISSION_CURRENT:
//     //     updatePacket(msg, PacketID::PKT_ID__MISSION_CURRENT, PSTR("MISSION_CURRENT"), sizeof(mavlink_mission_current_t));
//     //     break;
//     // case MAVLINK_MSG_ID_MOUNT_STATUS:
//     //     updatePacket(msg, PacketID::PKT_ID__MOUNT_STATUS, PSTR("MOUNT_STATUS"), sizeof(mavlink_mount_status_t));
//     //     break;
//     // case MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT:
//     //     updatePacket(msg, PacketID::PKT_ID__NAV_CONTROLLER_OUTPUT, PSTR("NAV_CONTROLLER_OUTPUT"), sizeof(mavlink_nav_controller_output_t));
//     //     break;
//     // case MAVLINK_MSG_ID_PARAM_REQUEST_READ:
//     //     updatePacket(msg, PacketID::PKT_ID__PARAM_REQUEST_READ, PSTR("PARAM_REQUEST_READ"), sizeof(mavlink_param_request_read_t));
//     //     break;
//     // case MAVLINK_MSG_ID_PARAM_REQUEST_LIST:
//     //     updatePacket(msg, PacketID::PKT_ID__PARAM_REQUEST_LIST, PSTR("PARAM_REQUEST_LIST"), sizeof(mavlink_param_request_list_t));
//     //     break;
//     // case MAVLINK_MSG_ID_PARAM_VALUE:
//     //     updatePacket(msg, PacketID::PKT_ID__PARAM_VALUE, PSTR("PARAM_VALUE"), sizeof(mavlink_param_value_t));
//     //     break;
//     // case MAVLINK_MSG_ID_POWER_STATUS:
//     //     updatePacket(msg, PacketID::PKT_ID__POWER_STATUS, PSTR("POWER_STATUS"), sizeof(mavlink_power_status_t));
//     //     break;
//     // case MAVLINK_MSG_ID_RAW_IMU:
//     //     updatePacket(msg, PacketID::PKT_ID__RAW_IMU, PSTR("RAW_IMU"), sizeof(mavlink_raw_imu_t));
//     //     break;
//     // case MAVLINK_MSG_ID_RC_CHANNELS:
//     //     updatePacket(msg, PacketID::PKT_ID__RC_CHANNELS, PSTR("RC_CHANNELS"), sizeof(mavlink_rc_channels_t));
//     //     break;
//     // case MAVLINK_MSG_ID_RC_CHANNELS_RAW:
//     //     updatePacket(msg, PacketID::PKT_ID__RC_CHANNELS_RAW, PSTR("RC_CHANNELS_RAW"), sizeof(mavlink_rc_channels_raw_t));
//     //     break;
//     // case MAVLINK_MSG_ID_RC_CHANNELS_SCALED:
//     //     updatePacket(msg, PacketID::PKT_ID__RC_CHANNELS_SCALED, PSTR("RC_CHANNELS_SCALED"), sizeof(mavlink_rc_channels_scaled_t));
//     //     break;
//     // case MAVLINK_MSG_ID_REMOTE_LOG_BLOCK_STATUS:
//     //     updatePacket(msg, PacketID::PKT_ID__REMOTE_LOG_BLOCK_STATUS, PSTR("REMOTE_LOG_BLOCK_STATUS"), sizeof(mavlink_remote_log_block_status_t));
//     //     break;
//     // case MAVLINK_MSG_ID_REQUEST_DATA_STREAM:
//     //     updatePacket(msg, PacketID::PKT_ID__REQUEST_DATA_STREAM, PSTR("REQUEST_DATA_STREAM"), sizeof(mavlink_request_data_stream_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SCALED_IMU2:
//     //     updatePacket(msg, PacketID::PKT_ID__SCALED_IMU2, PSTR("SCALED_IMU2"), sizeof(mavlink_scaled_imu2_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SCALED_IMU3:
//     //     updatePacket(msg, PacketID::PKT_ID__SCALED_IMU3, PSTR("SCALED_IMU3"), sizeof(mavlink_scaled_imu3_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SCALED_PRESSURE:
//     //     updatePacket(msg, PacketID::PKT_ID__SCALED_PRESSURE, PSTR("SCALED_PRESSURE"), sizeof(mavlink_scaled_pressure_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SCALED_PRESSURE2:
//     //     updatePacket(msg, PacketID::PKT_ID__SCALED_PRESSURE2, PSTR("SCALED_PRESSURE2"), sizeof(mavlink_scaled_pressure2_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SENSOR_OFFSETS:
//     //     updatePacket(msg, PacketID::PKT_ID__SENSOR_OFFSETS, PSTR("SENSOR_OFFSETS"), sizeof(mavlink_sensor_offsets_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SERVO_OUTPUT_RAW:
//     //     updatePacket(msg, PacketID::PKT_ID__SERVO_OUTPUT_RAW, PSTR("SERVO_OUTPUT_RAW"), sizeof(mavlink_servo_output_raw_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SET_MODE:
//     //     updatePacket(msg, PacketID::PKT_ID__SET_MODE, PSTR("SET_MODE"), sizeof(mavlink_set_mode_t));
//     //     break;
//     // case MAVLINK_MSG_ID_STATUSTEXT:
//     //     updatePacket(msg, PacketID::PKT_ID__STATUSTEXT, PSTR("STATUSTEXT"), sizeof(mavlink_statustext_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SYS_STATUS:
//     //     updatePacket(msg, PacketID::PKT_ID__SYS_STATUS, PSTR("SYS_STATUS"), sizeof(mavlink_sys_status_t));
//     //     break;
//     // case MAVLINK_MSG_ID_SYSTEM_TIME:
//     //     updatePacket(msg, PacketID::PKT_ID__SYSTEM_TIME, PSTR("SYSTEM_TIME"), sizeof(mavlink_system_time_t));
//     //     break;
//     // case MAVLINK_MSG_ID_TIMESYNC:
//     //     updatePacket(msg, PacketID::PKT_ID__TIMESYNC, PSTR("TIMESYNC"), sizeof(mavlink_timesync_t));
//     //     break;
//     // case MAVLINK_MSG_ID_TERRAIN_REPORT:
//     //     updatePacket(msg, PacketID::PKT_ID__TERRAIN_REPORT, PSTR("TERRAIN_REPORT"), sizeof(mavlink_terrain_report_t));
//     //     break;
//     // case MAVLINK_MSG_ID_VFR_HUD:
//     //     updatePacket(msg, PacketID::PKT_ID__VFR_HUD, PSTR("VFR_HUD"), sizeof(mavlink_vfr_hud_t));
//     //     break;
//     // case MAVLINK_MSG_ID_VIBRATION:
//     //     updatePacket(msg, PacketID::PKT_ID__VIBRATION, PSTR("VIBRATION"), sizeof(mavlink_vibration_t));
//     //     break;
//     default:
//         // Handle unknown message IDs if necessary
//         break;
//   }
// }


// void mMAVLink_Decoder::updatePacket(const mavlink_message_t& msg, PacketID packetId, const char* name, size_t dataSize) 
// {
//   for (auto& packet : packets) {
//     if (packet.packetId == packetId) {
//       // ALOG_INF(PSTR("updatePacket = %d \"%S\""), packetId, name);
//       packet.tUpdate = millis();
//       memcpy(packet.data, &msg, dataSize);
//       return;
//     }
//   }
...
//   newPacket.data = std::malloc(dataSize);
//   memcpy(newPacket.data, &msg, dataSize);
//   packets.push_back(newPacket);
// }

// // Function to find packet data by ID
// PacketData* mMAVLink_Decoder::findPacketData(PacketID id) {
//     for (auto& packet : packetDataVector) {
//         if (packet.id == id) {
//             return &packet;
//         }
//     }
...
PacketData* mMAVLink_Decoder::findPacketData(uint16_t packetID) {
    for (auto& packet : packets) {
        if (packet.packetID == packetID) {
            return &packet;
        }
...
// // Function to update packet data
// void mMAVLink_Decoder::updatePacket(const mavlink_message_t &msg, PacketID id, const char* packet_name, size_t data_size) {
//     PacketData* packet = findPacketData(id);
//     if (packet == nullptr) {
//         // Allocate and initialize new packet data if it doesn't exist
//         PacketData newPacket;
//         newPacket.id = id;
//         newPacket.tUpdate = millis();
//         newPacket.data = new uint8_t[data_size];
//         packetDataVector.push_back(newPacket);
//         packet = &packetDataVector.back();
//     }

//     // Update the timestamp
//     packet->tUpdate = millis();

//     // Decode and copy the data into the packet
//     mavlink_ahrs2_t data;
//     mavlink_msg_ahrs2_decode(&msg, &data);
...
// const char* mMAVLink_Decoder::MavLink_Msg_FriendlyName_By_ID(PacketID id) {
//     // for (const auto& packet : packets) {
//     //     if (packet.packetId == id) {
//     //         return packet.name.c_str();
//     //     }
//     // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_Overview_01(uint8_t json_level, bool json_appending) {
    ...
    // // Heartbeat
    // PacketData* packet_heartbeat = findPacketData(PacketID::PKT_ID__HEARTBEAT);
    ...
    // // Statustext
    // PacketData* packet_statustext = findPacketData(PacketID::PKT_ID__STATUSTEXT);
    ...
    // // GoPro Heartbeat
    // PacketData* packet_gopro_heartbeat = findPacketData(PacketID::PKT_ID__GOPRO_HEARTBEAT);
    ...
    // // HW Status
    // PacketData* packet_hwstatus = findPacketData(PacketID::PKT_ID__HWSTATUS);
    ...
    // // Meminfo
    // PacketData* packet_meminfo = findPacketData(PacketID::PKT_ID__MEMINFO);
    ...
    // // Mission Current
    // PacketData* packet_mission_current = findPacketData(PacketID::PKT_ID__MISSION_CURRENT);
...
uint8_t mMAVLink_Decoder::ConstructJSON_Overview_02(uint8_t json_level, bool json_appending) {
    ...
    // PacketData* packet_nav_controller_output = findPacketData(PacketID::PKT_ID__NAV_CONTROLLER_OUTPUT);
    ...
    // // RC Channels
    // PacketData* packet_rc_channels = findPacketData(PacketID::PKT_ID__RC_CHANNELS);
    ...
    // // Scaled IMU2
    // PacketData* packet_scaled_imu2 = findPacketData(PacketID::PKT_ID__SCALED_IMU2);
    ...
    // // Scaled Pressure
    // PacketData* packet_scaled_pressure = findPacketData(PacketID::PKT_ID__SCALED_PRESSURE);
    ...
    // // Sys Status
    // PacketData* packet_sys_status = findPacketData(PacketID::PKT_ID__SYS_STATUS);
    ...
    // // Terrain Report
    // PacketData* packet_terrain_report = findPacketData(PacketID::PKT_ID__TERRAIN_REPORT);
    ...
    // // VFR HUD
    // PacketData* packet_vfr_hud = findPacketData(PacketID::PKT_ID__VFR_HUD);
...
uint8_t mMAVLink_Decoder::ConstructJSON_ahrs2(uint8_t json_level, bool json_appending)
{
  ...
  // PacketData* packet = findPacketData(PacketID::PKT_ID__AHRS2);
  // if (packet == nullptr || packet->data == nullptr) {
  //   return 0; // Handle error
  // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_Debug_ReceiveStats(uint8_t json_level, bool json_appending) {
    ...
    // for (const auto& packet : packets) {
    //     JBI->Add(packet.name.c_str(), millis() - packet.tUpdate);
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_attitude(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__ATTITUDE);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_autopilot_version(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__AUTOPILOT_VERSION);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_battery_status(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__BATTERY_STATUS);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_ekf_status_report(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__EKF_STATUS_REPORT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_fence_status(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__FENCE_STATUS);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_gimbal_report(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__GIMBAL_REPORT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_gimbal_torque_cmd_report(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__GIMBAL_TORQUE_CMD_REPORT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_global_position_int(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__GLOBAL_POSITION_INT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_gopro_heartbeat(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__GOPRO_HEARTBEAT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_gps_global_origin(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__GPS_GLOBAL_ORIGIN);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
    ...
    // JBI->Add("flagstime_usec", data->time_usec); /*< Timestamp (microseconds since UNIX epoch or microseconds since system boot)*/
    return JBI->End();
}

uint8_t mMAVLink_Decoder::ConstructJSON_gps_raw_int(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__GPS_RAW_INT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_heartbeat(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__HEARTBEAT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_home_position(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__HOME_POSITION);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
    ...
    // JBI->Array_AddArray("q", data->q, 4); /*< World to surface normal and heading transformation of the takeoff position. Used to indicate the heading and slope of the ground*/
...
uint8_t mMAVLink_Decoder::ConstructJSON_hwstatus(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__HWSTATUS);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_local_position_ned(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__LOCAL_POSITION_NED);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_meminfo(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__MEMINFO);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_mission_current(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__MISSION_CURRENT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_mount_status(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__MOUNT_STATUS);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_nav_controller_output(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__NAV_CONTROLLER_OUTPUT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_param_value(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__PARAM_VALUE);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
    ...
    // JBI->Array_AddArray("param_id", data->param_id, ARRAY_SIZE(data->param_id));
...
uint8_t mMAVLink_Decoder::ConstructJSON_power_status(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__POWER_STATUS);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_raw_imu(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__RAW_IMU);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_rc_channels(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__RC_CHANNELS);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_rc_channels_raw(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__RC_CHANNELS_RAW);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_rc_channels_scaled(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__RC_CHANNELS_SCALED);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_request_data_stream(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__REQUEST_DATA_STREAM);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_imu2(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__SCALED_IMU2);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_imu3(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__SCALED_IMU3);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_scaled_pressure(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__SCALED_PRESSURE);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_scaled_pressure2(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__SCALED_PRESSURE2);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_sensor_offsets(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__SENSOR_OFFSETS);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_servo_output_raw(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__SERVO_OUTPUT_RAW);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_statustext(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__STATUSTEXT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_sys_status(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__SYS_STATUS);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_system_time(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__SYSTEM_TIME);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_timesync(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__TIMESYNC);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_terrain_report(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__TERRAIN_REPORT);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_vfr_hud(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__VFR_HUD);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
...
uint8_t mMAVLink_Decoder::ConstructJSON_vibration(uint8_t json_level, bool json_appending) {
    // PacketData* packet = findPacketData(PacketID::PKT_ID__VIBRATION);
    // if (packet == nullptr || packet->data == nullptr) {
    //     return 0; // Handle error
    // }
