...
#define D_UNIQUE_MODULE__DRIVERS__HBRIDGE_ID 4011 // [(Folder_Number*100)+ID_File]
...
class mHBridge :
  ...
  public:
    ...
    static constexpr const char* PM_MODULE_DRIVERS__HBRIDGE_CTR = D_MODULE__DRIVERS__HBRIDGE__CTR;
    PGM_P GetModuleName(){          return PM_MODULE_DRIVERS__HBRIDGE_CTR; }
    uint16_t GetModuleUniqueID(){ return D_UNIQUE_MODULE__DRIVERS__HBRIDGE_ID; }
