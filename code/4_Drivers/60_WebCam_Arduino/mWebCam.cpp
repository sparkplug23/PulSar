...
const char* mWebCamera::PM_MODULE_DRIVERS__CAMERA_ARDUINO__CTR = D_MODULE_DRIVERS__CAMERA_ARDUINO__CTR;
const char* mWebCamera::PM_MODULE_DRIVERS__CAMERA_ARDUINO__FRIENDLY_CTR = D_MODULE_DRIVERS__CAMERA_ARDUINO__FRIENDLY_CTR;
...
{    
  for(auto& handle:mqtthandler_list){
    pCONT_mqtt->MQTTHandler_Command(*this, EM_MODULE_DRIVERS__CAMERA_ARDUINO__ID, handle, id);
  }
}
