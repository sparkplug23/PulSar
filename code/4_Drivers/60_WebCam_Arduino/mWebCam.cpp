...
#ifdef USE_MODULE_DRIVERS_CAMERA_ARDUINO

const char* mWebCamera::PM_MODULE_DRIVERS_CAMERA_ARDUINO_CTR = D_MODULE_DRIVERS_CAMERA_ARDUINO_CTR;
const char* mWebCamera::PM_MODULE_DRIVERS_CAMERA_ARDUINO_FRIENDLY_CTR = D_MODULE_DRIVERS_CAMERA_ARDUINO_FRIENDLY_CTR;
...
{    
  for(auto& handle:mqtthandler_list){
    pCONT_mqtt->MQTTHandler_Command(*this, EM_MODULE__DRIVERS_CAMERA_ARDUINO__ID, handle, id);
  }
}
