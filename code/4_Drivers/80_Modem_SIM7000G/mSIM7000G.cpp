...
const char* mSIM7000G::PM_MODULE__NETWORK_CELLULAR__CTR = D_MODULE__NETWORK_CELLULAR__CTR;
const char* mSIM7000G::PM_MODULE__NETWORK_CELLULAR__FRIENDLY_CTR = D_MODULE__NETWORK_CELLULAR__FRIENDLY_CTR;
 ...
 * */
void mSIM7000G::MQTTHandler_Sender(uint8_t id)
{
  for(auto& handle:mqtthandler_list){
