...
uint8_t mBuzzer::ConstructJSON_Settings(uint8_t json_level, bool json_object_start_end_required){
...
uint8_t mBuzzer::ConstructJSON_Sensor(uint8_t json_level, bool json_object_start_end_required){
