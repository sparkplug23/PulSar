...
// char *mFileSystem::folderOnly(char *fname){
...
// char *mFileSystem::fileOnly(char *fname){
//   char *cp = fname;
...
// uint32_t mFileSystem::UfsSize(void) {
//   return UfsInfo(0, ufs_dir == 2 ? 1:0);
// }

// uint32_t mFileSystem::UfsFree(void) {
