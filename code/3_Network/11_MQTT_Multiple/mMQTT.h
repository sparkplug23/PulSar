#ifndef _NETWORK_MQTT_H
#define _NETWORK_MQTT_H

#define D_UNIQUE_MODULE_NETWORK_MQTT_MULTIPLE_ID  ((3*1000)+11)
  ...
  public mTaskerInterface
{
  ...
  public:
    ...
    static const char* PM_MODULE_NETWORK_MQTT_MULTIPLE_CTR;
    static const char* PM_MODULE_NETWORK_MQTT_MULTIPLE_FRIENDLY_CTR;
    PGM_P GetModuleName(){          return PM_MODULE_NETWORK_MQTT_MULTIPLE_CTR; }
    PGM_P GetModuleFriendlyName(){  return PM_MODULE_NETWORK_MQTT_MULTIPLE_FRIENDLY_CTR; }
    uint16_t GetModuleUniqueID(){ return D_UNIQUE_MODULE_NETWORK_MQTT_MULTIPLE_ID; }
