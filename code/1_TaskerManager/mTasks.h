...
// "PRE_INIT" should be changed to PIN_INIT, and "MODULE_POINTER" should be possibly removed as its either PIN_INIT or INIT
  ...
  * *************************************************************************************************************************************************/
  ...
  // Wifi 
  //
  TASK_WEBSERVER_START, TASK_WEBSERVER_STOP, // replacing reliance on wifi connected, since we need this for softAP
 ...
 * */
  ...
  TASK_NETWORK_CONNECTED__ANY, TASK_NETWORK_LOST__ANY,
