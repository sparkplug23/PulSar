...
// "PRE_INIT" should be changed to PIN_INIT, and "MODULE_POINTER" should be possibly removed as its either PIN_INIT or INIT
  ...
  * *************************************************************************************************************************************************/
  ...
  TASK_EVERY_30_SECOND, 
  TASK_EVERY_MINUTE, 
  TASK_EVERY_30_MINUTES,
  TASK_EVERY_HOUR, TASK_EVERY_MIDNIGHT, TASK_EVERY_MIDDAY,
  ...
  TASK_RESTART_SET_DO_FINAL_CLEANUP, 
  ...
  // Mqtt
  TASK_MQTT_SUBSCRIBE, TASK_MQTT_CONNECTED, TASK_MQTT_DISCONNECTED, TASK_MQTT_COMMAND, TASK_TELEMETRY__SENDER_MQTT,
  TASK_TELEMETRY_REFRESH_SEND_ALL,
  //TASK_MQTT_HANDLERS_RESET, 
  TASK_TELEMETRY_SET_DEFAULT_TRANSMIT_PERIOD,
  TASK_MQTT_CHECK_REDUNCTION_LEVEL, 
  TASK_MQTT_DATA_ID,



  TASK_SHOWLOG_SENSOR_READING,
  ...
  TASK_WEB_APPEND_SENSOR_TABLE_VALUES,
  TASK_WEB_APPEND_DRIVER_TABLE_VALUES,
  TASK_WEB_APPEND_CONTROLLER_TABLE_VALUES,
 ...
 * */
  ...
  TASK_DISPLAY_CONNECTION_ESTABLISHED,
  TASK_DISPLAY_CONNECTION_FAILED,
  ...
  /**
   * Each time a hardware connects, it must also broadcast to ANY so either is valid task control
   * Tasker(TASK_NETWORK_CONNECTED__WIFI); Tasker(TASK_NETWORK_CONNECTED__ANY);
   * 
   */
  TASK_NETWORK_CONNECTED__WIFI, TASK_NETWORK_LOST__WIFI,
  TASK_NETWORK_CONNECTED__ETHERNET, TASK_NETWORK_LOST__ETHERNET,
  TASK_NETWORK_CONNECTED__CELLULAR, TASK_NETWORK_LOST__CELLULAR,
...
DEFINE_PGM_CTR(PM_TASK_NETWORK_CONNECTED__WIFI_CTR)                          D_TASK_NETWORK_CONNECTED__WIFI_CTR;
DEFINE_PGM_CTR(PM_TASK_NETWORK_LOST__WIFI_CTR)                       D_TASK_NETWORK_LOST__WIFI_CTR;
...
DEFINE_PGM_CTR(PM_TASK_TELEMETRY__SENDER_MQTT_CTR)                             D_TASK_TELEMETRY__SENDER_MQTT_CTR;
