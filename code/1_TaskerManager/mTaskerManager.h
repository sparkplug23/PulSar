...
STATIC_ASSERT_JSON_TEMPLATE_FITS(FUNCTION_TEMPLATE);
#endif
#ifdef USE_LIGHTING_TEMPLATE
STATIC_ASSERT_JSON_TEMPLATE_FITS(LIGHTING_TEMPLATE);
#endif
#ifdef USE_RULES_TEMPLATE
STATIC_ASSERT_JSON_TEMPLATE_FITS(RULES_TEMPLATE);
#endif
// #ifdef USE_FUNCTION_TEMPLATE__OVERRIDE
// STATIC_ASSERT_JSON_TEMPLATE_FITS(FUNCTION_TEMPLATE__OVERRIDE);
// #endif
// #ifdef USE_LIGHTING_TEMPLATE__OVERRIDE
// STATIC_ASSERT_JSON_TEMPLATE_FITS(LIGHTING_TEMPLATE__OVERRIDE);
// #endif
// #ifdef USE_RULES_TEMPLATE__OVERRIDE
// STATIC_ASSERT_JSON_TEMPLATE_FITS(RULES_TEMPLATE__OVERRIDE);
// #endif
...
#include "4_Drivers/03_LEDs/mLEDs.h"
  ...
  #include "4_Drivers/05_SDCard/mSDCard.h"
 ...
 **/
  ...
  #define tkr_spulse                             static_cast<mPulseCounter*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_SENSORS_PULSECOUNTER_ID))
#endif
#ifdef USE_MODULE_SENSORS_REMOTE_DEVICE
  #include "5_Sensors/20_RemoteDevice/mRemoteDevice.h"
  #define tkr_sremote                            static_cast<mRemoteDevice*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_SENSORS_REMOTE_DEVICE_ID))
#endif
 ...
 **/
  ...
  #define tkr_ade7953                            static_cast<mEnergyADE7953*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_ENERGY_ADE7953_ID))
#endif
 ...
 **/
  ...
  #define tkr_oled1306                           static_cast<mOLED_SSD1306*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_DISPLAYS_OLED_SSD1306_ID))
#endif
 ...
 **/
  ...
  #define tkr_ifan                               static_cast<mSonoffIFan*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_SONOFF_IFAN_ID))
#endif
#ifdef USE_MODULE_CONTROLLER_FAN
  #include "9_Controller/Fan/mFan.h"
  #define tkr_mfan                               static_cast<mFan*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_FAN_ID))
#endif
// 3d printer encoder here
  ...
  #define tkr_doorbell                           static_cast<mDoorBell*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_DOORBELL_ID))
#endif
#ifdef USE_MODULE_CONTROLLER_GPS_SD_LOGGER
  #include "9_Controller/GPS_SD_Logger/mGPS_SD_Logger.h"
  #define tkr_gps_sd_log                         static_cast<mGPS_SD_Logger*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_GPS_SD_LOGGER_ID))
  ...
  #define tkr_sdcardlogger                       static_cast<mSDCardLogger*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_SDCARDLOGGER_ID))
#endif
...
// USE_MODULE_CONTROLLER_INTERNAL_CLOCK
  ...
  #define tkr_hvac_remote                        static_cast<mHVAC_Remote*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_HVAC_REMOTE_ID))
#endif
...
// 51_Animator_Playlists
  ...
  #define tkr_mEnergyOnOLED                      static_cast<mEnergyOnOLED*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER__ENERGY_OLED__ID))
#endif
/**
 ...
 **/  
  ...
  #define tkr_sbut                               static_cast<mRadiatorFan*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_RADIATORFAN_ID))
#endif
#ifdef USE_MODULE_CONTROLLER_IMMERSION_TANK_COLOUR
  #include "10_ConSpec/01_ImmersionTankColour/mImmersionTankColour.h"
  #define tkr_msenscol                           static_cast<mImmersionTankColour*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_IMMERSION_TANK_COLOUR_ID))
#endif
#ifdef USE_MODULE_CONTROLLER_FURNACE_SENSOR
  #include "10_ConSpec/03_FurnaceSensor/mFurnaceSensor.h"
  #define tkr_furnace_sensor                     static_cast<mFurnaceSensor*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_FURNACE_SENSOR_ID))
#endif
#ifdef USE_MODULE_CONTROLLER__LOUVOLITE_HUB
  #include "10_ConSpec/04_LouvoliteHub/mLouvoliteHub.h"
  #define tkr_louv                               static_cast<mLouvoliteHub*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER__LOUVOLITE_HUB__ID))
#endif
  ...
  #define tkr_sdlight                            static_cast<mSideDoorLight*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_CUSTOM__SIDEDOOR_LIGHT__ID))
#endif
#ifdef USE_MODULE_CONTROLLER_CUSTOM__IMMERSION_PANEL
  #include "10_ConSpec/06_ImmersionPanel/mImmersionPanel.h"
  #define tkr_immersion_cont                     static_cast<mImmersionPanel*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_CUSTOM__IMMERSION_PANEL__ID))
#endif
#ifdef USE_MODULE_CONTROLLER_CUSTOM__PORTABLE_TEMPSENSOR_OLED
  #include "10_ConSpec/07_TempSensorOnOLED/mTempSensorOLEDBath.h"
  #define tkr_immersion_cont                     static_cast<mTempSensorOLEDBath*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_CUSTOM__PORTABLE_TEMPSENSOR_OLED__ID))
#endif
#ifdef USE_MODULE_CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX
  #include "10_ConSpec/08_CellularBlackBox/mCellularBlackBox.h"
  #define tkr_immersion_cont                     static_cast<mCellularBlackBox*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX__ID))
#endif
  ...
  #define tkr_cont_mavlinoled                    static_cast<mMAVLink_Decoder_OLED*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_CUSTOM__CELLULAR_MAVLINK_BLACK_BOX_OLED__ID))
#endif
#ifdef USE_MODULE_CONTROLLER_CUSTOM__ENERGY_OLED
  #include "10_ConSpec/10_EnergyOnOLED/mEnergyOnOLED.h"
  #define tkr_mEnergyOnOLED                      static_cast<mEnergyOnOLED*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_CUSTOM__ENERGY_OLED__ID))
#endif
#ifdef USE_MODULE_CONTROLLER_CUSTOM__3DPRINTER_ENCLOSURE
  #include "10_ConSpec/11_3DPrinterEnclosure/Printer3D.h"
  #define tkr_3dprinter                          static_cast<mPrinter3D*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_CUSTOM__3DPRINTER_ENCLOSURE__ID))
#endif
  ...
  #define tkr_cont_imu_rad                       static_cast<mSDLoggerIMURadiationPattern*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_SDLOGGER_IMU_RADIATIONPATTERN_ID))
#endif
  ...
  #define tkr_serial_pos_log                     static_cast<mSerialPositionalLogger*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_SERIAL_POSITIONAL_LOGGER_ID))
#endif
  ...
  #define tkr_serial_calibration_log             static_cast<mSerialCalibrationMeasurmentLogger*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_SERIAL_CALIBRATION_PIC32_LOGGER_ID))
#endif
#ifdef USE_MODULE_CONTROLLER_CUSTOM__MAVLINK_FLYING_LEDS
  #include "10_ConSpec/19_MAVLinkFlyingLEDS/mMAVLinkFlyingLEDS.h"
  #define tkr_mavlink_leds                       static_cast<mMavlinkFlyingLEDS*>(mTaskerManager::GetInstance()->GetModule(D_UNIQUE_MODULE_CONTROLLER_CUSTOM__MAVLINK_FLYING_LEDS__ID))
#endif
