...
// #define DEVICE_VALIDATION__ESP32__MINIMAL_DEVKIT
...
"}";
...
#ifdef DEVICE_VALIDATION__ESP32__SENSORS_ALL
  #ifndef DEVICENAME_CTR
  #define DEVICENAME_CTR          "validation"
  #endif
  #ifndef DEVICENAME_FRIENDLY_CTR
  ...
  ************************************/   
  ...
  // #define USE_MODULE_SENSORS_MOON_TRACKING
  #define USE_MODULE_SENSORS__TOF_VL53L0X
  #define USE_MODULE_SENSORS__TOF_VL53L1X
  #define USE_MODULE_SENSORS__RADAR_HLK_LD2410
...
#ifdef DEVICE_VALIDATION__ESP32__DRIVERS_ALL
  #ifndef DEVICENAME_CTR
  #define DEVICENAME_CTR          "validation"
  #endif
  #ifndef DEVICENAME_FRIENDLY_CTR
