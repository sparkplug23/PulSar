#ifndef MFIRMWARECUSTOM_SECRET_HEADER
#define MFIRMWARECUSTOM_SECRET_HEADER
 ...
 * This can also be added into platformio_override.ini to permit automatic device selection
 * */
...
#endif // MFIRMWARECUSTOM_SECRET_HEADER