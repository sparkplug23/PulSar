 ...
 */
  ...
  #define USE_MODULE_LIGHTS_ADDRESSABLE
    #define ENABLE_PIXEL_FUNCTION_SEGMENTS_ANIMATION_EFFECTS
    // Functional things to be integrated after testing  
    #define ENABLE_DEVFEATURE_NEOPIXELBUS_INTO_SEGMENTS_STRUCT // Towards making bus dynamic and multiple pins
    #define ENABLE_DEVFEATURE_FIXING_SEGMENT_LENGTH_SIZE
    #define ENABLE_DEVFEATURE_ENABLE_INTENSITY_TO_REPLACE_PERCENTAGE_CHANGE_ON_RANDOMS
    #define ENABLE_DEBUG_FEATURE_MQTT_ANIMATOR_DEBUG_PALETTE
    ...
    #define ENABLE_DEVFEATURE_UNIFIED_SEGMENT_STRUCT_SWITCH_TO_MY_VARIABLES
    // #define ENABLE_DEVFEATURE_UNIFIED_SEGMENT_REMOVING_MY_CODE
    ...
    #define ENABLE_DEVFEATURE_NEWPALETTE_CONTAINER
