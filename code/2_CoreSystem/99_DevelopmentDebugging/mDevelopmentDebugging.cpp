...
void mDevelopmentDebugging::SubTask_Show_Defines_Ready_To_Phase_Out()
{
  ...
  #error "ENABLE_DEBUGFEATURE_LIGHT__MULTIPIN_JUNE28
  #endif
  ...
  #warning "ENABLE_DEVFEATURE_ALWAYS_LOAD_PALETTE_WHEN_NOT_TRANSITIONING phase out"
  #endif
  ...
  #error "ENABLE_DEVFEATURE__MQTT_ENABLE_SENDING_LIMIT_MS should stay, but I dont want this enabled by default until motion bug is fixed"
  #endif
