...
// New method keeps ADC in core.
// It only becomes a driver if a physical external device is used.

// Keeping it here, means other modules can use it once configured.



#ifdef USE_MODULE_CORE_ADC

int8_t mADC::Tasker(uint8_t function, JsonParserObject obj)
{
