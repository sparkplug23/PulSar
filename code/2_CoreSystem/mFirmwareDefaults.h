...
// -------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  #define FIRMWARE_DEFAULT__LIGHTING_CONFIG__2D // Inherit base config
...
#define FIRMWARE_DEFAULT__LIGHTING_CONFIG__AUGUST2025 // temporary add below
 ...
 * FIRMWARE_DEFAULT__LIGHTING_CONFIG__SOUND_REACTIVE // all 1D and 2D and sound reactive
