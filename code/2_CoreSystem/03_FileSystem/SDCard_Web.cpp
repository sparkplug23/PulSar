...
//     if (!sdcard.fs->exists(path))
//     {
//       request->send(404, "text/plain", "File not found");
//       return;
//     }

//     File file = sdcard.fs->open(path, FILE_READ);
...
//   File file = sdcard.fs->open(path, FILE_WRITE);
...
//     request->_tempFile = sdcard.fs->open(path, FILE_WRITE);
//   }
