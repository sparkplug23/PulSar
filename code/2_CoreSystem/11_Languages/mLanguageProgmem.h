...
DEFINE_PGM_CTR(PM_AZIMUTH) "Azimuth";
DEFINE_PGM_CTR(PM_ANGLES) "Angles";
...
DEFINE_PGM_CTR(PM_DST_ACTIVE)           D_DST_ACTIVE;
...
DEFINE_PGM_CTR(PM_IS_SUN_RISING)     D_IS_SUN_RISING;
...
DEFINE_PGM_CTR(PM_MQTT_BROKERS)           "MqttBrokers";
DEFINE_PGM_CTR(PM_MQTT_ALLOWED)           "MqttAllowed";
DEFINE_PGM_CTR(PM_MQTT_CONNECTED)         "MqttConnected";
DEFINE_PGM_CTR(PM_MQTT_CONNECTCOUNT)      "MqttConnectCount";
DEFINE_PGM_CTR(PM_MQTT_DOWNTIME_COUNTER)  "MqttDowntimeCounter";
...
DEFINE_PGM_CTR(PM_SUN_ELEVATION_MAX)          D_SUN_ELEVATION "Max";
DEFINE_PGM_CTR(PM_SUN_ELEVATION_MIN)          D_SUN_ELEVATION "Min";
...
DEFINE_PGM_CTR(PM_WIFI_CHANNEL)            "WiFiChannel";
DEFINE_PGM_CTR(PM_WIFI_SLEEP)            "WiFiSleep";
