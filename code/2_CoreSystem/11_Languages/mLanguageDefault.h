...
#define D_MODULE__CORE__SETTINGS__CTR                 "settings"
#define D_MODULE__CORE__FILESYSTEM__CTR               "filesystem"
#define D_MODULE__CORE__TEMPLATE_LOADING__CTR         "templates"
#define D_MODULE__CORE__HARDWAREPINS__CTR             "gpio"
#define D_MODULE__CORE__SUPPORT__CTR                  "support"
#define D_MODULE__CORE__TIME__CTR                     "time"
#define D_MODULE__CORE__LOGGING__CTR                  "logging"
#define D_MODULE__CORE__TELEMETRY__CTR                "telemetry"
#define D_MODULE__CORE__CRASH_RECORDER__CTR           "crashrecorder"
#define D_MODULE__CORE__EVENTS__CTR                   "events"
#define D_MODULE__CORE__RULES__CTR                    "rules"
#define D_MODULE__CORE__UPDATES__CTR                  "update"
#define D_MODULE__CORE__SERIAL__CTR                   "serial"
#define D_MODULE__CORE__I2C__CTR                      "i2c"
#define D_MODULE__CORE__SPI__CTR                      "spi"
#define D_MODULE__CORE__ADC__CTR                      "adc"
#define D_MODULE__CORE__PWM__CTR                      "pwm"
#define D_MODULE__CORE__PINVIEWER__CTR                "pin_viewer"
#define D_MODULE__CORE__DEVELOPMENT_DEBUGGING__CTR    "debug_development"

/**************************************************************************************************
 * Network
 **************************************************************************************************/

#define D_MODULE__NETWORK__INTERFACE__CTR             "interface_network"
#define D_MODULE__NETWORK__WIFI__CTR                  "wifi"
#define D_MODULE__NETWORK__ETHERNET__CTR              "ethernet"
#define D_MODULE__NETWORK__CELLULAR__CTR              "cellular"
#define D_MODULE__NETWORK__MQTT__CTR                  "mqtt"
#define D_MODULE__NETWORK__WEBSERVER__CTR             "webserver"

/**************************************************************************************************
 * Drivers
 **************************************************************************************************/

#define D_MODULE__DRIVERS__INTERFACE__CTR             "interface_drivers"
#define D_MODULE__DRIVERS__LEDS__CTR                  "leds"
#define D_MODULE__DRIVERS__RELAY__CTR                 "relays"
#define D_MODULE__DRIVERS__SDCARD__CTR                "sd_card"
#define D_MODULE__DRIVERS__IRTRANSCEIVER__CTR         "ir"
#define D_MODULE__DRIVERS__IRREMOTE__CTR              "ir_rremote"
#define D_MODULE__DRIVERS__SERVOS__CTR                "servos"
#define D_MODULE__DRIVERS__RF433_CODES__CTR           "rf433"
#define D_MODULE__DRIVERS__HBRIDGE__CTR               "hbridge"
#define D_MODULE__DRIVERS__SHELLY_DIMMER__CTR         "shellydimmer"
#define D_MODULE__DRIVERS__BUZZER__CTR                "buzzer"
#define D_MODULE__DRIVERS__MODEM_7000G__CTR           "modem_7000g"
...
#define D_MODULE__SENSORS__INTERFACE__CTR             "interface_sensor"
#define D_MODULE__SENSORS__SWITCHES__CTR              "switches"
#define D_MODULE__SENSORS__BUTTONS__CTR               "buttons"
#define D_MODULE__SENSORS__BME__CTR                   "bme"
#define D_MODULE__SENSORS__DB18S20__CTR               "db18s20"
#define D_MODULE__SENSORS__DHT__CTR                   "dht"
#define D_MODULE__SENSORS__BH1750__CTR                "bh1750"
#define D_MODULE__SENSORS__PIR__CTR                   "motion"
#define D_MODULE__SENSORS__DOOR__CTR                  "doorsensor"
#define D_MODULE__SENSORS__L3G__CTR                   "l3g"
#define D_MODULE__SENSORS__LDR_BASIC__CTR           "ldr_basic"
#define D_MODULE__SENSORS__LSM303D__CTR               "lsm303d"
#define D_MODULE__SENSORS__MOISTURE_ADC__CTR          "moisure_adc"
#define D_MODULE__SENSORS__SR04__CTR                  "sr04"
#define D_MODULE__SENSORS__MPU9250__CTR             "mpu9250"
#define D_MODULE__SENSORS__PULSECOUNTER__CTR        "pulsecounter"
#define D_MODULE__SENSORS__REMOTE_DEVICE__CTR       "remotedevice"
#define D_MODULE__SENSORS__ROTARY_ENCODER__CTR      "rotary_encoder"
#define D_MODULE__SENSORS__SUN_TRACKING__CTR          "solar"
#define D_MODULE__SENSORS__SUN_TRACKING_FAST_ESTIMATE__CTR          "solar"
#define D_MODULE__SENSORS__MOON_TRACKING__CTR         "lunar"
#define D_MODULE__SENSORS__TOF_VL53L0X__CTR           "tof_vl53l0x"
#define D_MODULE__SENSORS__TOF_VL53L1X__CTR           "tof_vl53l1x"
#define D_MODULE__SENSORS__RADAR_HLK_LD2410__CTR      "hlk_ld2410"
#define D_MODULE__SENSORS__ADC_INTERNAL__CTR        "adc_internal"
#define D_MODULE__SENSORS__ESP32_TEMPERATURE__CTR     "esp32_temperature"
#define D_MODULE__SENSORS__GPS_SERIAL__CTR            "gps_serial"

/**************************************************************************************************
 * Lights
 **************************************************************************************************/

#define D_MODULE__LIGHTS__INTERFACE__CTR              "interface_lights"
#define D_MODULE__LIGHTS__ANIMATOR__CTR               "pixels"

/**************************************************************************************************
 * Energy
 **************************************************************************************************/

#define D_MODULE__ENERGY__INTERFACE__CTR              "interface_energy"
#define D_MODULE__ENERGY__PZEM004T__CTR               "pzem004t"
#define D_MODULE__ENERGY__ADE7953__CTR                "ade7953"
#define D_MODULE__ENERGY__INA219__CTR                 "ina219"

/**************************************************************************************************
 * Displays
 **************************************************************************************************/

#define D_MODULE__DISPLAYS__INTERFACE__CTR            "interface_displays"
#define D_MODULE__DISPLAYS__NEXTION__CTR              "nextion"
#define D_MODULE__DISPLAYS__OLED_SSD1306__CTR         "sh1306"
#define D_MODULE__DISPLAYS__OLED_SH1106__CTR          "sh1106"

/**************************************************************************************************
 * Controllers
 **************************************************************************************************/

#define D_MODULE__CONTROLLER__SCHEDULAR__CTR         "ceilingfan"
#define D_MODULE__CONTROLLER__SONOFF_IFAN__CTR       "ceilingfan"
#define D_MODULE__CONTROLLER__FAN_PWM__CTR           "fan"
#define D_MODULE__CONTROLLER__TANKVOLUME__CTR       "tankvolume"
#define D_MODULE__CONTROLLER__BUCKET_WATER_LEVEL__CTR "bucket_water_level"
#define D_MODULE__CONTROLLER__DOORBELL__CTR         "doorbell"
#define D_MODULE__CONTROLLER__GPS_SD_LOGGER__CTR    "sdcardlogger"
#define D_MODULE__CONTROLLER__SDCARDLOGGER__CTR     "sdcardlogger"
#define D_MODULE__CONTROLLER__HVAC__CTR               "hvac"
#define D_MODULE__CONTROLLER__HVAC_REMOTE__CTR        "hvac_remote"
#define D_MODULE__CONTROLLER__SENSOR_COLOUR_BAR__CTR "sensor_colourbar"
#define D_MODULE__CONTROLLER__RELAY_STATE_LEDSTRIP__CTR "relay_state_ledstrip"
#define D_MODULE__CONTROLLER__ANIMATOR_BUTTON_CONTROLS__CTR "anim_anim_buttons"
#define D_MODULE__CONTROLLER__ENERGY_OLED__CTR      "energy_oled"
// #define D_MODULE__CONTROLLER__SERIAL_CALIBRATION_PIC32_LOGGER__CTR "serial_calib_pic32"
// #define D_MODULE__CONTROLLER__USERMOD_01__CTR       "usermod_01"
// #define D_MODULE__CONTROLLER__SDLOGGER_IMU_RADIATIONPATTERN__CTR "imu_radiation_pattern"
// #define D_MODULE__CONTROLLER__BLINDS__CTR           "blinds"

/**************************************************************************************************
 * Controllers Custom
 **************************************************************************************************/

#define D_MODULE__CONTROLLER_CUSTOM__RADIATORFAN__CTR "radiatorfan"
#define D_MODULE__CONTROLLER_CUSTOM__IMMERSION_TANK_COLOUR__CTR "sensor_colours"
#define D_MODULE__CONTROLLER_CUSTOM__FURNACE_SENSOR__CTR "furnace_sensor"
#define D_MODULE__CONTROLLER_CUSTOM__LOUVOLITE_HUB__CTR "louvolite"
#define D_MODULE__CONTROLLER_CUSTOM__SIDEDOOR_LIGHTS__CTR "sidedoor_lights"
#define D_MODULE__CONTROLLER_CUSTOM__IMMERSION_PANEL__CTR "immersion_panel"
#define D_MODULE__CONTROLLER_CUSTOM__CELLULAR_BLACK_BOX__CTR "blackbox"
#define D_MODULE__CONTROLLER_CUSTOM__CELLULAR_MAVLINK_BLACK_BOX_OLED__CTR  "controller_mavlink_oled"
#define D_MODULE__CONTROLLER_CUSTOM__ENERGY_OLED__CTR                      "oled_show_power"
#define D_MODULE__CONTROLLER_CUSTOM__3DPRINTER_ENCLOSURE__CTR              "printer_enclosure"
#define D_MODULE__CONTROLLER_CUSTOM__TREADMILL_LOGGER__CTR                 "treadmill_logger"
#define D_MODULE__CONTROLLER_CUSTOM__SERVER_RESET_RELAYS__CTR              "server_relay_reset"
#define D_MODULE__CONTROLLER_CUSTOM__POSITIONAL_LOGGER__CTR                "serial_positional_logger"
#define D_MODULE__CONTROLLER_CUSTOM__MAVLINK_FLYING_LEDS__CTR              "mavlink_flying_leds"
#define D_MODULE__CONTROLLER_CUSTOM__DESK_SENSORS_ON_OLED__CTR             "sensors_oled"
...
#define D_MODULE__CONTROLLER_CUSTOM__OLED_NITC_AMBIENT__CTR "custom_oled_nitc_ambient"
