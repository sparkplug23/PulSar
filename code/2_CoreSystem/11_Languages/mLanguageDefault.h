...
#define D_MODULE_CONTROLLER_CUSTOM__WLED_WEBUI_DEVELOPER__FRIENDLY_CTR  "wled_webui"
#define D_MODULE_CONTROLLER_CUSTOM__WLED_WEBUI_DEVELOPER__CTR "wled_webui"
