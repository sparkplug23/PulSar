 ...
 * 
 * @description
 * Module that links basic connection status and info from SIM7000 during development
 * and show connection information
 */
...
const char* mOLED_SIM7000::PM_MODULE_CONTROLLER_CEILINGFAN_CTR = D_MODULE_CONTROLLER_CEILINGFAN_CTR;
const char* mOLED_SIM7000::PM_MODULE_CONTROLLER_CEILINGFAN_FRIENDLY_CTR = D_MODULE_CONTROLLER_CEILINGFAN_FRIENDLY_CTR;

int8_t mOLED_SIM7000::Tasker(uint8_t function, JsonParserObject obj)
{
...
void mOLED_SIM7000::RulesEvent_Set_Speed(){
...
uint8_t mOLED_SIM7000::GetFanspeed(void)
{
...
uint8_t mOLED_SIM7000::GetLightState(void)
{
  return pCONT_mry->CommandGet_Relay_Power(0);
}
void mOLED_SIM7000::SetLightState(uint8_t state)
{
...
void mOLED_SIM7000::SetFanSpeed(uint8_t fanspeed, bool sequence)
{
...
// void mOLED_SIM7000::SonoffIfanReceived(void)
// {
//   char svalue[32];
...
bool mOLED_SIM7000::SerialInput(void)
{
  AddLog(LOG_LEVEL_TEST,PSTR("mOLED_SIM7000::SerialInput"));
//   if (SONOFF_IFAN03 == my_module_type) {
...
void mOLED_SIM7000::SpeedRefresh(void)
{
  // if (SONOFF_IFAN03 == my_module_type) {
    if (ifan_fanspeed_timer) {
      ifan_fanspeed_timer--;
...
uint8_t mOLED_SIM7000::ConstructJSON_Settings(uint8_t json_level, bool json_appending){
...
uint8_t mOLED_SIM7000::ConstructJSON_Power(uint8_t json_level, bool json_appending){
...
void mOLED_SIM7000::MQTTHandler_Init(){

  struct handler<mOLED_SIM7000>* ptr;
  ...
  ptr->ConstructJSON_function = &mOLED_SIM7000::ConstructJSON_Settings;
  ...
  ptr->ConstructJSON_function = &mOLED_SIM7000::ConstructJSON_Power;
 ...
 * */
void mOLED_SIM7000::MQTTHandler_Set_RefreshAll()
{
 ...
 * */
void mOLED_SIM7000::MQTTHandler_Set_DefaultPeriodRate()
{
  for(auto& handle:mqtthandler_list){
 ...
 * */
void mOLED_SIM7000::MQTTHandler_Sender(uint8_t id)
{
  for(auto& handle:mqtthandler_list){
