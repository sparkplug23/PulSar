  ...
  public mTaskerInterface
{
  ...
  public:
    ...
    static const char* PM_MODULE_CONTROLLER__ENERGY_OLED_CTR;
    static const char* PM_MODULE_CONTROLLER__ENERGY_OLED_FRIENDLY_CTR;
    PGM_P GetModuleName(){          return PM_MODULE_CONTROLLER__ENERGY_OLED_CTR; }
    PGM_P GetModuleFriendlyName(){  return PM_MODULE_CONTROLLER__ENERGY_OLED_FRIENDLY_CTR; }
