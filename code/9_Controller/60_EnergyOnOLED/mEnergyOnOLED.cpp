...
const char* mEnergyOLED::PM_MODULE_CONTROLLER__ENERGY_OLED_CTR = D_MODULE_CONTROLLER__ENERGY_OLED_CTR;
const char* mEnergyOLED::PM_MODULE_CONTROLLER__ENERGY_OLED_FRIENDLY_CTR = D_MODULE_CONTROLLER__ENERGY_OLED_FRIENDLY_CTR;
