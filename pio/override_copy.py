...
if os.path.isfile("HomeControlSystem/0_ConfigUser/G0_mFirmwareCustom_Secret.h"): # (G)enerated file (0)
    ...
    f = open("HomeControlSystem/0_ConfigUser/G0_mFirmwareCustom_Secret.h", "a")
    f.write(write_output)


## Generate mUserConfig using Example

if os.path.isfile("HomeControlSystem/0_ConfigUser/G1_mUserConfig_Secret.h"):
    ...
    # Open (and create) a new file to write in to
    f = open("HomeControlSystem/0_ConfigUser/G1_mUserConfig_Secret.h", "a")
    f.write(write_output)
