...
// #define DEBUG_ASYNC_TCP(...)  Serial.println(__VA_ARGS__);//while(((U0S >> USTXC) & 0x7F) != 0x00); os_printf( __VA_ARGS__ ); while(((U0S >> USTXC) & 0x7F) != 0x00)

// #define DEBUG_ASYNC_TCP(...)  while(((U0S >> USTXC) & 0x7F) != 0x00); ets_printf( __VA_ARGS__ ); while(((U0S >> USTXC) & 0x7F) != 0x00)
