/*-------------------------------------------------------------------------
Neo5ByteElements provides feature base classes to describe color elements
...
class Neo5ByteElementsBase
{
public:
    static const size_t PixelSize = 5;
...
class Neo5ByteElements : public Neo5ByteElementsBase
{
public:
    typedef RgbwColor ColorObject;
};

class Neo5ByteRgbElements : public Neo5ByteElementsBase
{
public:
    typedef RgbColor ColorObject;
};

class Neo5ByteElementsNoSettings : public Neo5ByteElements
{
public:
