...
*/
#ifndef _ESPAsyncWebServer2_H_
#define _ESPAsyncWebServer2_H_
...
class AsyncWebServerRequest {
  ...
  private:
    ...
    // LinkedList<AsyncWebHeader *> _headers2;//new headers
  ...
  public:
    ...
    // virtual void addHeader(const char* name, const char* value);//new headers
    // virtual uint16_t _assembleHead(char* header_ptr, uint8_t version, uint16_t header_maximum_size = 300);//new headers
    

    AsyncClient* client(){ 
      //Serial.println("client() ret"); 
      return _client; }
    ...
    // Only supported for legacy
    void send_serial(int code, uint8_t contentType=0, char* content=nullptr);
    ...
    // void send_P(int code, const char* contentType, const uint8_t * content, size_t len, AwsTemplateProcessor callback=nullptr);
    // void send_P(int code, const char* contentType, PGM_P content, AwsTemplateProcessor callback=nullptr);
    void send_P(int code, uint8_t contentType, const uint8_t * content, size_t len, AwsTemplateProcessor callback=nullptr);
    void send_P(int code, uint8_t contentType, PGM_P content, AwsTemplateProcessor callback=nullptr);
    ...
    AsyncWebServerResponse *beginResponse_P(int code, uint8_t contentType, const uint8_t * content, size_t len, AwsTemplateProcessor callback=nullptr);
    AsyncWebServerResponse *beginResponse_P(int code, uint8_t contentType, PGM_P content, AwsTemplateProcessor callback=nullptr);
    ...
    bool hasParam(const char* name) const;         // check if argument exists
    bool hasParam(const __FlashStringHelper * data) const;         // check if F(argument) exists
...
class AsyncWebServerResponse {
  ...
  public:
    ...
    virtual void setContentType(uint8_t type);
    virtual void addHeader(const char* name, const char* value);
    virtual uint16_t _assembleHead(char* header_ptr, uint8_t version, uint16_t header_maximum_size = 300);
