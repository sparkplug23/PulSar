  ...
  if(request->method() == HTTP_GET){
    if(request->hasParam("list")){
...
#endif
      output += "]";
      request->send_serial(200, CONTENT_TYPE_APPLICATION_JSON_ID, (char*)output.c_str());
      output = String();
    }
      ...
      if (request->header("If-Modified-Since").equals(buildTime)) {
        ...
        AsyncWebServerResponse *response = request->beginResponse_P(200, CONTENT_TYPE_TEXT_HTML_ID, edit_htm_gz, edit_htm_gz_len);
