...
static be_define_const_map_slots(be_class_light_state_map) {
    ...
    { be_const_key(reverse_gamma10, 13), be_const_static_ctype_func(ls_rev_gamma10) },
    ...
    { be_const_key(gamma10, 0), be_const_static_ctype_func(ls_gamma10) },
    { be_const_key(get, 22), be_const_func(light_state_get) },
    { be_const_key(gamma8, -1), be_const_static_ctype_func(ls_gamma8) },
