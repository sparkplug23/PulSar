...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(resolvecmnd, 96), be_const_func(l_resolveCmnd) },
    { be_const_key(arch, 60), be_const_func(l_arch) },
    ...
    { be_const_key(try_rule, 55), be_const_closure(Tasmota_try_rule_closure) },
    { be_const_key(_rules, 37), be_const_var(1) },
    ...
    { be_const_key(wd, -1), be_const_var(2) },
    ...
    { be_const_key(add_fast_loop, 31), be_const_closure(Tasmota_add_fast_loop_closure) },
    { be_const_key(eth, 97), be_const_func(l_eth) },
    ...
    { be_const_key(response_append, 62), be_const_func(l_respAppend) },
    ...
    { be_const_key(gen_cb, 83), be_const_closure(Tasmota_gen_cb_closure) },
    ...
    { be_const_key(settings, 93), be_const_var(4) },
    { be_const_key(get_switches, 72), be_const_func(l_getswitch) },
    ...
    { be_const_key(add_cmd, 52), be_const_closure(Tasmota_add_cmd_closure) },
    { be_const_key(resp_cmnd_done, 2), be_const_func(l_respCmndDone) },
    ...
    { be_const_key(next_cron, 58), be_const_closure(Tasmota_next_cron_closure) },
    ...
    { be_const_key(get_light, 18), be_const_closure(Tasmota_get_light_closure) },
    { be_const_key(strftime, -1), be_const_func(l_strftime) },
    { be_const_key(_timers, 17), be_const_var(8) },
    { be_const_key(_global_def, -1), be_const_comptr(&be_tasmota_global_struct) },
    { be_const_key(read_sensors, 73), be_const_func(l_read_sensors) },
    { be_const_key(find_list_i, 35), be_const_closure(Tasmota_find_list_i_closure) },
    ...
    { be_const_key(publish, 21), be_const_func(be_mqtt_publish) },
    ...
    { be_const_key(set_timer, 94), be_const_closure(Tasmota_set_timer_closure) },
    ...
    { be_const_key(resp_cmnd_str, 78), be_const_func(l_respCmndStr) },
    { be_const_key(cmd_res, 32), be_const_var(9) },
    ...
    { be_const_key(_fl, -1), be_const_var(10) },
    ...
    { be_const_key(exec_rules, 5), be_const_closure(Tasmota_exec_rules_closure) },
    { be_const_key(find_op, 47), be_const_closure(Tasmota_find_op_closure) },
    { be_const_key(get_switch, -1), be_const_func(l_getswitch) },
    { be_const_key(_debug_present, 44), be_const_var(11) },
    { be_const_key(resp_cmnd_error, -1), be_const_func(l_respCmndError) },
    { be_const_key(gc, -1), be_const_closure(Tasmota_gc_closure) },
    { be_const_key(rtc_utc, 34), be_const_func(l_rtc_utc) },
    { be_const_key(add_rule, -1), be_const_closure(Tasmota_add_rule_closure) },
    { be_const_key(get_free_heap, 26), be_const_func(l_getFreeHeap) },
    { be_const_key(version, -1), be_const_ctype_func(be_Tasmota_version) },
    ...
    { be_const_key(_crons, 82), be_const_var(12) },
};
