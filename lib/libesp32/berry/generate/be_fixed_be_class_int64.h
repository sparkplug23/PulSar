...
static be_define_const_map_slots(be_class_int64_map) {
    { be_const_key(_X2B, 4), be_const_ctype_func(int64_add) },
    { be_const_key(set, 7), be_const_ctype_func(int64_set) },
    ...
    { be_const_key(tobytes, 10), be_const_ctype_func(int64_tobytes) },
    { be_const_key(_p, -1), be_const_var(0) },
    { be_const_key(_X3E, -1), be_const_ctype_func(int64_gt) },
    { be_const_key(fromstring, 5), be_const_static_ctype_func(int64_fromstring) },
    ...
    { be_const_key(_X21_X3D, 15), be_const_ctype_func(int64_nequals) },
